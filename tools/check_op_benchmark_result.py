...
def load_benchmark_result_from_logs_dir(logs_dir):
    ...
    def result_lambda(log_file):
        return log_file, parse_log_file(log_file_path(log_file))
...
def update_api_info_file(fail_case_list, api_info_file):
    ...
    def parse_case_id_f(x):
        return x.split()[0].rsplit("_", 1)
...
if __name__ == "__main__":
    ...
    for log_file in sorted(pr_log_files):
        ...
        compare_benchmark_result(case_name, develop_result, pr_result, check_results)
