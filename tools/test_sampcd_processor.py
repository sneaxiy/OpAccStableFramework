...
from sampcd_processor import (execute_samplecode,
                              extract_code_blocks_from_docstr, find_all,
                              find_last_future_line_end, get_api_md5,
                              get_incrementapi, get_test_capacity,
                              insert_codes_into_codeblock, is_required_match,
...
class Test_find_last_future_line_end(unittest.TestCase):
    ...
    def test_1_instant(self):
        ...
        self.assertGreaterEqual(find_last_future_line_end(samplecodes), mo.end())
...
class Test_execute_samplecode(unittest.TestCase):
    ...
    def test_run_success(self):
        result, tfname, msg, exec_time = execute_samplecode(self.successSampleCodeFile)
    ...
    def test_run_failed(self):
        result, tfname, msg, exec_time = execute_samplecode(self.failedSampleCodeFile)
...
class Test_sampcd_extract_to_file(unittest.TestCase):
    ...
    def test_2_samplecodes_has_skipped(self):
        ...
        self.assertCountEqual(sampcd_processor.SUMMARY_INFO["xpu"], [funcname + "-4"])
        self.assertCountEqual(
