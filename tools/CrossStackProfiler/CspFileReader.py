...
class FileReader:
    ...
    def _getFileList(self):
        ...
        for file in self._fileList:
            ...
            if id not in idList:
                ...
                raise NotImplementedError(
                    "[%s] is repeated by id, we don not how to process it!" % file
                )
    ...
    def _getId(self, fileName, organizeForm, sed="."):
        if self._organizeForm != organizeForm:
            raise TypeError(
                "Can not get rank id when organizer form is not %s!" % organizeForm
            )
        ...
        try:
            ...
            print(e)
            raise TypeError(
                "invalid fileName [%s], the prefix should be a number!" % fileName
            )
