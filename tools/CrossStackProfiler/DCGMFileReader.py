...
import pandas as pd
from CspFileReader import (FILEORGANIZEFORM_BYTRAINER, PIPELINEINFO_TRACE_NUM,
                           FileReader, dcgmMetricParameterMap, getLogger)
    ...
    def _parseSingleFile(self, fileName):
        ...
        with open(fileName, "r") as fp:
            ...
            for line in fp:
                ...
                if not line.strip().startswith("GPU") and not line.strip().startswith(
                    "# Entity"
                ):
                    continue
...
def test_dcgmFileReader():
    ...
    testReader.getDCGMTraceInfo(0, 8)
