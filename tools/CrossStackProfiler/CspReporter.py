...
from CspFileReader import (DCGM_PATH, FILEORGANIZEFORM_BYRANK,
                           FILEORGANIZEFORM_BYTRAINER, NET_PATH, PROFILE_PATH,
                           TIME_PATH, getLogger)
...
class CspReporter:
    ...
    def _generateTraceFileByGroup(self, groupId, processNum):
        ...
        self._dcgmFileReader.getDCGMTraceInfo(groupId, processNum)
        ...
        self._profileFileReader.getOPTraceInfo(groupId)
